...
syn region jinjaArgument contained start=/"/ end=/"/
syn region jinjaArgument contained start=/'/ end=/'/
...
" syntax region jinja2TemplateStatement
"      \ start="{%" end="%}"
" syntax region jinja2TemplateExpressions
"      \ start="{{" end="}}"
" 
" highlight def jinja2TemplateStatement guibg=#00005f ctermbg=17
" highlight def link jinja2TemplateExpressions guibg=#00005f ctermbg=17

let b:current_syntax = "python_jinja2template"
